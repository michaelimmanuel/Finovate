...
function buildAIInsight({
  ...
  const sum = (arr: typeof last7) => arr.reduce((s, d) => s + d.expenses, 0);

  const last7Expenses = sum(last7);
  const prev7Expenses = sum(prev7);

  const trendUp = prev7.length > 0 && last7Expenses > prev7Expenses * 1.1;
  const trendDown = prev7.length > 0 && last7Expenses < prev7Expenses * 0.9;
  ...
  if (trendUp) {
    ...
    text += " Spending trend in the last week is stable — good consistency.";
  }
    ...
    <main className="max-w-7xl mx-auto p-6 space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          Data kamu update realtime. Tambah expenses/income → chart langsung
          berubah.
        </p>
      </div>
            ...
            <CardContent className="space-y-4 text-muted-foreground">
              <ul className="list-disc pl-6 space-y-3 text-base">
                <li>
                  ...
                  Your income has shown a consistent upward trend this month.
                  This positive growth provides an excellent opportunity to
                  allocate more funds toward savings or investments.
                </li>
                <li>
                  <span className="font-semibold text-primary">
                    Expense Stability:
                  </span>{" "}
                  Your daily expenses remain stable, indicating good control
                  over discretionary spending. However, review recurring
                  expenses to identify any potential savings.
                </li>
                <li>
                  <span className="font-semibold text-primary">
                    Savings Rate:
                  </span>{" "}
                  Consider setting a target to save at least 20% of your monthly
                  income. Automating transfers to a dedicated savings account
                  can help you achieve this goal effortlessly.
                </li>
                <li>
                  <span className="font-semibold text-primary">
                    Emergency Fund:
                  </span>{" "}
                  If you haven't already, build an emergency fund covering 3–6
                  months of living expenses to provide security in case of
                  unexpected events.
                </li>
                <li>
                  <span className="font-semibold text-primary">
                  ...
                  Regularly review your budget and adjust categories as your
              ...
              <div className="pt-2">
                ...
                <ol className="list-decimal pl-6 space-y-2 text-base">
                  <li>
                    Increase your monthly savings by 5–10% to take advantage of
                    rising income.
                  </li>
                  <li>
                    Audit subscriptions and recurring payments for possible
                    reductions.
                  </li>
                  <li>
                    Set a monthly spending cap for non-essential categories.
                  </li>
